...
import { KeyRound, Loader, LogIn, UserPlus } from "lucide-react";
...
// type ApiUser = { email: string; role: "admin" | "user"; credits: number; usedCredits?: number };
...
// // Si tu backend corre en otro puerto, ponlo en un .env del front (Vite):
// // VITE_API_BASE=http://localhost:5179
// const API_BASE = (import.meta as any).env?.VITE_API_BASE || "";
...
//     // (si quieres mantener el “delay visual”)
//     setTimeout(async () => {
//       const res = await apiLogin(email.trim(), password);
...
//                   onChange={(e) => setEmail(e.target.value)}
//                   placeholder="you@email.com"
//                   className="w-full bg-black/50 border-2 border-neon-cyan/60 font-code text-center text-lg py-2 px-4 rounded focus:outline-none focus:border-neon-pink focus:shadow-neon-pink transition-all"
//                 />
//               </div>
...
//                 </label>
//                 <div className="relative">
//                   <KeyRound className="absolute left-3 top-3 text-neon-cyan opacity-50" size={18} />
//                   <input
//                     type="password"
//                     value={password}
//                     onChange={(e) => setPassword(e.target.value)}
//                     placeholder="********"
//                     className={`w-full bg-black/50 border-2 font-code text-center text-lg py-2 pl-10 pr-4 rounded focus:outline-none transition-all
//                       ${
//                         status === "ERROR"
//                           ? "border-red-500 text-red-400"
//                           : "border-neon-cyan/60 text-neon-cyan focus:border-neon-pink focus:shadow-neon-pink"
//                       }
//                     `}
//                   />
//                 </div>
